...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { category: @drink.category, product: @drink.product, rating: @drink.rating } }, as: :json
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { category: @drink.category, product: @drink.product, rating: @drink.rating } }, as: :json
    assert_response 200
  end
