...
RSpec.describe WebhooksController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new webhook" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new webhook" do
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the webhook" do
        webhook = Webhook.create! valid_attributes
